...
| 8 | C.2B.11 — Old-Root Quarantine & Rollback Contract | Eski root’u read-only quarantine yapmak ve rollback token kuralları — **NOT STARTED** (C.2B.9b'de quarantine primitive'i var; rollback token contract yok) | Security + Runtime | HIGH | C.2B.10 | two-root/rollback P0-P1 | Git untracking, cutover |
